...
<html lang="pt-br">
  ...
  <div class="row">
        ...
        <div class="col-md-2">
                <!-- Modal -->
                <div class="modal fade" id="add_telefone_modal_funcionario" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="ip_add_telefone_funcionario" id="label-add-telefone"><strong>Telefone</strong></label>
                            <input class="form-control" id="ip_add_telefone_funcionario" aria-describedby="telefone" placeholder="(99) 99999-9999">
                        </div>
                        <div class="modal-footer">
                          <button type="button" class="btn btn-danger" data-dismiss="modal">Fechar</button>
                          <button id="btn_conf_add_telefone_funcionario" type="submit" class="btn btn-success">Adicionar</button>
                        </div>
